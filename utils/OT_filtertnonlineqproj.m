function [fltrd_data,fltrd_dataP] =  OT_filtertnonlineqproj(theta_samples,measured_output,cost,weight,OT_constants,Optimal_Transport,L)
    ...
    Kp = Sigxd/Sigdd;
    fltrd_dataP = fltrd_data + Kp*(L^2*ones(1,Ns)-X1);
end